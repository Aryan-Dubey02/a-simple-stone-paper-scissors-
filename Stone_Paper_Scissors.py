...
def game_start():
    ...
    turn_display = Label(root, text=n, font = ("Arial", 10),bg='lightblue')
...
sps_label = Label(root, text="Rock Paper Scissor", font=("Arial", 30, "bold"),bg="LightBlue")
sps_label.place(x= 200, y=0)

n_label = Label(root, text="Enter the number of rounds you want to play:", font=("Arial", 10),bg="lightblue")
n_label.place(x=200, y= 50)

n_entry = Entry(root, textvariable= number_of_times, font=("Arial", 10),bg="lightblue")
n_entry.place(x= 500, y=50 )

n_submit = Button(root, text= "Submit", font=("Arial", 10), height=1, width=5,bg="LightBlue" ,command=lambda: game_start() )
n_submit.place(x = 500, y= 75)


#making of main game labels 
pl = Label(root, text="Player Score", font=("Arial", 20),bg="LightBlue")
bot = Label(root, text="Bot Score",font=("Arial", 20),bg="LightBlue" )

player_score = Label(root, text="0", font=("Arial", 10),bg="LightBlue")
bot_score = Label(root, text="0", font=("Arial", 10),bg="LightBlue" )

No_Of_Turns = Label(root, text="Number of turns chosen",  font = ("Arial", 20),bg="LightBlue")
turn_display = Label(root, text=n, font = ("Arial", 10),bg="LightBlue")
...
drop_list.current(0)
drop_list.config(background="lightblue")

submit = Button(root, text="Submit", font = ("Arial", 10) , height= 1, width= 5, background= "LightBlue",command= lambda: game_run() )
...
def game_run():
    ...
    if choice == 0 and bot_choice == 1:
            final_message = Label(root, text="Bot wins this round.", font = ("Arial", 15),bg="lightblue")
            ...
            final_message = Label(root, text="Player wins this round.", font = ("Arial", 15),bg='lightblue')
            final_message.place(x = 350, y = 240)
            palyerg+=1
            v = str(palyerg)
        ...
        final_message = Label(root, text="This is a tie round", font = ("Arial", 15),bg='lightblue')
        final_message.place(x = 350, y = 240)
